export default function ContactoPage() {
  const contactPhone = process.env.NEXT_PUBLIC_CONTACT_PHONE || '+595 (993) 547 294';
  const contactEmail = process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'info@experience-club.online';
  const whatsappPhone = process.env.NEXT_PUBLIC_ZAP_PHONE || '595986338849';
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-gray-400"
                    required
                  />
                </div>
                <div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-green-600">Resposta imediata</p>
                </div>
              </div>
              <a
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-800">Horários</h3>
                    <p className="text-gray-600">Segunda a Sábado: 8:00 - 18:00</p>
                  </div>
                </div>
              </div>
            </div>
