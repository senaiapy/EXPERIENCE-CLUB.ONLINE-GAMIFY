...
const carouselSlides: CarouselSlide[] = [
  {
    id: 1,
    image: '/xbox-carousel.png',
    title: 'Games',
    description: 'Descubre nuestra exclusiva colección games'
  },
  {
    id: 2,
  ...
  {
    id: 3,
    image: '/computadores-carousel.png',
    title: 'computadores',
    description: 'Descubre nuestra exclusiva colección computadores'
  },
  {
    id: 4,
  ...
  {
    id: 5,
    image: '/celulares-carousel.png',
    title: 'Celulares',
    description: 'Descubre nuestra exclusiva colección celulares'
  },
  {
    id: 6,
