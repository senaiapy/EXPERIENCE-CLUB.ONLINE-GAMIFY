...
// Function to read and parse JSON data with pagination support
async function getBrandProducts(page: number = 1, limit: number = 12): Promise<{ products: BrandProduct[], total: number }> {
  try {
    ...
    // Filter products that have valid brand information
    ...
    const products = brandProducts.slice(start, end);
...
export default async function MarcasPage({ searchParams }: { searchParams: { page?: string } }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      {/* Brand Header */}
      <div className="bg-gradient-to-r from-purple-600 to-indigo-700 dark:from-purple-700 dark:to-indigo-800 py-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              ...
              <div>
                ...
                <p className="text-purple-200 dark:text-purple-300">Descubre nuestros productos por marca</p>
              </div>
            </div>
