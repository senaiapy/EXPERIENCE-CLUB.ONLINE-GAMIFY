...
export default function OrderConfirmationPage() {
  ...
  useEffect(() => {
    ...
    if (orderId) {
      // Load order from localStorage (in real app, this would be fetched from backend)
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-8">
              Verifica que hayas accedido correctamente desde el email de confirmación
            </p>
            <Link 
              href="/" 
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="font-medium text-yellow-700">Procesando</span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <p className="text-gray-600">
                Hemos enviado un email de confirmación a <strong>{order.customerInfo.email}</strong> con todos los detalles de tu pedido.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <p className="text-gray-600">
                Te mantendremos informado del estado de tu pedido a través de WhatsApp al número {order.customerInfo.phone}.
              </p>
            </div>
          </div>
