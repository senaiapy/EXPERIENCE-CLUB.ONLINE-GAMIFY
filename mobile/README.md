# Experience Club - Mobile App

Full-featured React Native cross-platform mobile application for Experience Club e-commerce platform (Paraguay). Built with Expo Router for iOS, Android, and Web.
...
**Network Access (WiFi):**
```bash
API_URL=http://192.168.x.x:3062/api
```
...
This mobile app integrates with the Experience Club monorepo:

- **Backend API**: [backend/](../backend/) - NestJS API (port 3062)
- **Frontend Web**: [frontend/](../frontend/) - Next.js storefront (port 3060)
- **Admin Panel**: [admin/](../admin/) - Next.js admin (port 3061)
