...
const BUNDLE_ID = 'com.experienceclub'; // ios bundle id
const PACKAGE = 'com.experienceclub'; // android package name
const NAME = 'ExperienceClub'; // app name
const EXPO_ACCOUNT_OWNER = 'senaiapy'; // expo account owner
const EAS_PROJECT_ID = '762f480f-9c15-44b5-99a6-e228c430a71c'; // Will be filled by eas project:init
const SCHEME = 'experienceclub'; // app scheme
...
const _clientEnv = {
  ...
  ZAP_PHONE: process.env.ZAP_PHONE,
};
