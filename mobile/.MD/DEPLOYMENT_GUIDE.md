# 🚀 Experience Club - Deployment Guide
...
- Bundle ID (iOS): `com.clubdeofertas`
- Package Name (Android): `com.clubdeofertas`
...
2. **Create New App**:
   ...
   - Bundle ID: `com.clubdeofertas` (must match app.json)
   - SKU: `clubdeofertas-001`
...
Your Experience Club e-commerce app is now deployed!
