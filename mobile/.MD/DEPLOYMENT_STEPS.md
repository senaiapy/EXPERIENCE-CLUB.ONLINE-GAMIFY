...
# This will ask: "Would you like to create a project for @senaiapy/clubdeofertas?"
# Answer: Yes
eas project:init
```
...
- Logged in as: senaiapy
- Environment variables configured
- Build profiles configured (development, staging, production)
- App identifiers set:
  - iOS Bundle ID: com.clubdeofertas.development / com.clubdeofertas.staging / com.clubdeofertas (production)
  - Android Package: com.clubdeofertas.development / com.clubdeofertas.staging / com.clubdeofertas (production)
