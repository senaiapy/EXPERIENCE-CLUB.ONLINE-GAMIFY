# Experience Club Mobile App - Quick Start Guide
...
npm run dev:start    # Backend on port 3062
```
...
- Review backend API docs at `http://localhost:3062/api/docs` (Swagger)
